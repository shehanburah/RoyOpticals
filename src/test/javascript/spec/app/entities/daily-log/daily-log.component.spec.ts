...
import { DailyLogComponent } from 'app/entities/daily-log/daily-log.component';
...
describe('Component Tests', () => {
  describe('DailyLog Management Component', () => {
    let comp: DailyLogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DailyLogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dailyLogs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
