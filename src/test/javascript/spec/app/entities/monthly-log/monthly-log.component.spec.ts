...
import { MonthlyLogComponent } from 'app/entities/monthly-log/monthly-log.component';
...
describe('Component Tests', () => {
  describe('MonthlyLog Management Component', () => {
    let comp: MonthlyLogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MonthlyLogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.monthlyLogs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
